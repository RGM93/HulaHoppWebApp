...
<html>
	...
	<div class="login">
            <div class="container">
                ...
                <h5 style=text-align: center> Introduce tu correo electrónico para verificar que estás en nuestra base de datos </h5>
                <div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
                    <form action="/ProyectoDAW/Usuarios/RecuperarPassword" method="POST" onsubmit="return validarForm2(this)">
                        <input name="email" id="email" type="email" placeholder="Correo Electónico" value="${param.email}" 
                            required=" " onkeyup="comprobarEmailDB()" style="background-repeat:no-repeat; background-position:right; background-size: 8%">
