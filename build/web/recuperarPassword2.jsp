<%-- 
    ...
    Created on : Jan 14, 2018, 1:23:44 AM
    Author     : Ruben
--%>
...
<html>
	...
	<div class="login">
            <div class="container" style="margin-bottom: 3%;">
                <h2>Cambio de Contraseña de cuenta en HulaHopp</h2>
                <h5 style=text-align: center> Introduce tu antigua y tu nueva contraseña </h5>
                <div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
                    <form action="/ProyectoDAW/Usuarios/RecuperarPassword2" method="POST" onsubmit="return validarForm3(this)">
                        <input hidden="true" name="email" id="email" value="${requestScope.email}">
                        <input name="oldPassword" id="oldPassword" type="password" placeholder="Contraseña anterior" required=" " 
                               onkeyup="comprobarPasswordDB()" style="background-repeat:no-repeat; background-position:right; background-size: 8%">
                        <input name="newPassword" type="password" placeholder="Contraseña nueva" required=" ">
