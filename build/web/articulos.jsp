            ...
            <div class="container">
                <div class="col-md-4 products-left">
                    <div class="categories">
                        ...
                        <ul class="cate"> 
                            <form action="/ProyectoDAW/Articulos/FiltroArticulos2?categoria=${requestScope.categoria}" method="POST" onsubmit="return validarFiltro(this)" style="margin-top: 5%;">
                                <input id="rangoPrecios" name="rangoPrecios" type="range" min="1" max="1000" value="1"class="slider">
                                <div style="padding-left: 38%; margin-top: 5%;">
                                    <p>Precio: <span id="resultadoPrecio" name="resultadoPrecio"></span>€</p>
                                </div>
                                <div style="padding: 2%; margin-top: 5%;">
                                    <p>Código Postal: <input id="cp" name="cp" type="text" value="${param.cp}" style="width: 50%; margin-left: 2%;"></p>
                                </div>
                                <div class="login-form-grids animated wow slideInUp" style=" width: 55%; padding: 0%; margin-bottom: 25%; background: transparent;" data-wow-delay=".5s">
                ...
                <div class="col-md-8 products-right">
                    <c:choose>
                        <c:when test="${requestScope.articulos != null}">
                            <c:forEach var="art" items="${requestScope.articulos}" begin="0" end="3" step="1">
                                                ...
                                                <figure>
                                                    <div class="snipcart-item block">
                                                        <div class="snipcart-thumb">
                                                            <a href="/ProyectoDAW/Articulos/Articulo?id=${art.id}&favMode=false"><img src="../images/${art.foto}" height="150px" width="150px"></a>		
                                                            <br><br><p> ${art.nombre} </p>
                                                            <h4> ${art.precio}€ </h4>
                                                        </div>
                                                    </div>
                                                </figure>
