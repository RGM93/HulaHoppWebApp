...
<html>
    ...
    <body>
        ...
        <div class="register">
            <div class="container">
                <h2>Regístrate en HulaHopp</h2>
                <div class="login-form-grids">
                    <h5>Datos necesarios para el registro</h5>
                    <form action="/ProyectoDAW/Usuarios/Alta" method="POST" onsubmit="return validarForm(this)">
                        <input name="email" id="email" value="${param.email}" type="email" placeholder="Correo Electrónico" required=" " onkeyup="validarEmailDB()"
                               style="background-repeat:no-repeat;
                               background-position:right; background-size: 8%">
                        <input name="password" id="password" type="password" placeholder="Contraseña" required=" " >
                        <input type="password" id="password2" placeholder="Confirmación de Contraseña" required="" >

                        <input name="name" id="name" value="${param.name}" type="text" placeholder="Nombre" required="" >
                        <input name="street" id="street" value="${param.street}" type="text" placeholder="Direccion">
                        <input name="zipcode" id="zipcode" value="${param.zipcode}" type="text" placeholder="Código Postal" required="">
                        <input name="facebook" id="facebook" value="${param.facebook}" type="text" placeholder="Facebook">
                        <input name="twitter" id="twitter" value="${param.twitter}" type="text" placeholder="Twitter">
                        <input name="phone" id="phone" value="${param.phone}" type="tel" placeholder="Teléfono" required="">
                        <div class="g-recaptcha" name="g-recaptcha" id="g-recaptcha" data-sitekey="6LdK4UIUAAAAANgc6YdAYNCbWQDZbNl8O3oJNgi8" style="margin-left: 13%; margin-top: 5%;"></div>
                        <input type="submit" value="Registrarse">
                    </form>

                </div>
                <div class="register-home">
                    <a href="/ProyectoDAW/Controlador/Home">Volver a Inicio</a>
                </div>
            </div>
        </div>
