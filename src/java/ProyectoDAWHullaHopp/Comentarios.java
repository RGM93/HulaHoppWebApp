...
@NamedQueries({
    ...
    @NamedQuery(name="Comentarios.findByPrivacity",
...
public class Comentarios implements Serializable {
    ...
    private Long id;
    private String texto, privacidad;
    ...
    public Usuarios getUsuario_2() {
        return usuario_2;
    }

    public void setUsuario_2(Usuarios usuario_2) {
    ...
    public String toString() {
        return "ProyectoDAWHullaHopp.Comentarios[ id=" + id + " ]";
    }
